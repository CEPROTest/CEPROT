...
def convert_examples_to_features(examples, args):
    ...
    for example_index, example in enumerate(tqdm(examples,total=len(examples))):
        ...
        source_ids =  focal_src_input_ids + focal_tgt_input_ids + test_src_input_ids
        source_mask = focal_src_attention_mask + focal_tgt_attention_mask + test_src_attention_mask
