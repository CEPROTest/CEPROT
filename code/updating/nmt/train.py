...
Options:
    ...
    --train-batch-size=<int>    train batch size [default: 16]
    --valid-batch-size=<int>    valid batch size [default: 16]
    --lr=<float>                learning rate [default: 0.001]
    --dropout=<float>           dropout rate [default: 0.0]
    --teacher-forcing=<float>   teacher forcing ratio [default: 1.0]
    --clip-grad=<float>         gradient clipping [default: 5.0]
    --log-every=<int>           log interval [default: 100]
    --valid-niter=<int>         validate interval [default: 1000]
    ...
    --save-to=<file>            model save path [default: model_myvacob.bin]
