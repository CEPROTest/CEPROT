...
# eval change
        ...
        # for debugging
        self.src_method = repr(instance['src_method'])[1:-1]
        self.tgt_method = repr(instance['dst_method'])[1:-1]
        self.src_desc = repr(instance['src_desc'])[1:-1]
        self.tgt_desc = repr(instance['dst_desc'])[1:-1]
