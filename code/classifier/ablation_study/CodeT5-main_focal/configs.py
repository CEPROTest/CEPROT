...
def add_args(parser):
    ...
    parser.add_argument("--summary_dir", default = '/cache',type=str, required=False)
    parser.add_argument("--data_dir", default = '/cache',type=str, required=False)
    parser.add_argument("--res_dir", default='/cache',type=str, required=False)
    ...
    parser.add_argument("--dev_filename", default='test.json', type=str,
    ...
    parser.add_argument("--max_source_length", default=150, type=int,
